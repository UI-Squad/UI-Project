	...
	<div class="topnav">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				...
				<a href="customViewAll.jsp" class ="active">View All</a>
			</div>
		</div>
