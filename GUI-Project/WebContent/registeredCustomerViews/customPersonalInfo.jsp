...
<body>
	...
	<h4> <a href="javascript:history.back()"> < back to shopping website</a> </h4>
	<h2>Checkout: Personal Information</h2>
	<div class="row">
		<div class="col-75">
			<div class="container">
				<form action="../customPersonalInfoServlet" method="POST">
					...
					<div class="row">
						<div class="col-50">
							...
							<input type="text" id="zip" name="zip" placeholder="State" required>
