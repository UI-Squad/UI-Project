...
<body>
	...
	<div class="topnav">
		...
		<a href="customCart.jsp">Cart</a> <a href="customInventory.jsp" class="active">Inventory</a>
	...
	<div class="row">
		...
		<div class="leftcolumn">
			<div class="card">
				<h3>Filter/Sort</h3>
				<a href="../customerFilterViews/byPriceLowInventory.jsp">Price: Low to High</a>
				<p></p>
				<a href="../customerFilterViews/byPriceHighInventory.jsp">Price: High to Low</a>
			</div>
		</div>
	</div>
