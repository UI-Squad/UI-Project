...
<html>
<head>
<title>Nile Shopping Service: Electronics</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="topnav">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="electronicsPage.jsp" class = "active">Electronics</a> 
	...
	<div class="row">
		...
		<div class="leftcolumn">
			<div class="card">
				<h3>Filter/Sort</h3>
				<a href="./filteredViews/priceLowSort.jsp">Price: Low to High</a>
				<p></p>
				<a href="./filteredViews/priceHighSort.jsp">Price: High to Low</a>
			</div>
		</div>
	</div>
