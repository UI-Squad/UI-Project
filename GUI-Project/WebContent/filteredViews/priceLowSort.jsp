	...
	<div class="row">
		<div class="rightcolumn">
			...
			<%
				...
				String department = dept.substring(0, 1).toUpperCase() + dept.substring(1);

			%>
			<div class="card">

				<h2><%=department%> - Sorted by Price: Low to High</h2>
		...
		<div class="leftcolumn">
			<div class="card">
				<h3>Filter/Sort</h3>
				<a href="javascript:history.back()"><font color="000000">Back to previous results</font></a>
				<p></p>
				<a href="priceHighSort.jsp"><font color="000000">Price: High to Low</font></a>
				<p></p>
			</div>
		</div>
	</div>
