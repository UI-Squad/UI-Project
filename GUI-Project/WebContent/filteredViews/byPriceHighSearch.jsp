	...
	<div class="row">
		<div class="rightcolumn">
			...
			<div class="card">
				...
				<h3>High-to-Low Filter Results For: ${searchValue}</h3>
		...
		<div class="leftcolumn">
			<div class="card">
				<h3>Filter/Sort</h3>
				<a href="javascript:history.back()">Back to original results</a>
				<p></p>
				<a href="byPriceLowSearch.jsp">Price: Low to High</a>
				<p></p>
			</div>
		</div>
	</div>
